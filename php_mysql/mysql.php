...
class mysql{
	...
	private $port;         //mysql的端口号
	private $mysqlSock;         //mysql.sock文件位置
	private $sql;	  //sql执行语句
	private $row;     //返回的条目数
	...
	public function connect()
	{
		...
		if($this->conn=="pconn"){
			...
			//即时链接
			$this->conn=mysqli_connect($this->db_host,$this->db_user,$this->db_pwd,$this->db_database,$this->port,$this->mysqlSock);
		}
